...
- `MANUAL` — стабилизированный ручной полёт: signed collective,
  roll/pitch по углу, yaw по скорости с удержанием курса при отпущенном стике;
...
- `AUTO` — автономная waypoint-миссия, полностью хранящаяся и исполняющаяся
  на борту;
- EKF3-позиция от одной UWB-метки (`AP_Beacon`/Nooploop), курс от компаса;
...
| RC4 | yaw rate; в центре — compass heading hold |
...
5. Откалибровать компас с работающими BLDC и исключить магнитное насыщение.
