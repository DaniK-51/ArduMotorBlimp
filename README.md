...
- независимый watchdog даёт neutral и disarm при остановке main loop на 1 с.

SITL протестирован. Аппаратная сборка для `MicoAir743v2` проверена на стенде
(DShot300, реверсивный 3D-режим, e-stop; 2026-09-04). Пошаговая загрузка,
